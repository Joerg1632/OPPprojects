...
vector<double> solveMinimalResidualMethod(vector<vector<double>>& A, vector<double>& b, vector<double>& x) {
...
>>>>>>> 864decfdd945de7a020646e5cc838b009c4f5a5c
